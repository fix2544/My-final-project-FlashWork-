        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="hireForm">
                        <div class="mb-3">
                            <label for="projectName" class="form-label">Work name</label>
                        ...
                        <div class="mb-3">
                            <label for="timeline" class="form-label">Time period</label>
                            <input type="text" class="form-control" id="timeline" required>
                        </div>
                        <div class="mb-3">
                            <label for="clientInfo" class="form-label">Your contact Information(Ex Facebook, Phone number or etc.)</label>
                            <input type="text" class="form-control" id="clientInfo" required>
                        </div>
